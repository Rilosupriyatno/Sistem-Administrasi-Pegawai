...
class Admin extends BaseController
{
    ...
    public function updateMutasi($id)
    {
        ...
        // ];
        // $this->historiModel->update($NIK, $data);
    ...
    // public function deleteLog($NIK)
    // {
    //     // $pegawai = $this->adminModel->find($id);
    //     // if ($pegawai['foto'] != 'default.svg') {
    //     //     unlink('img/' . $pegawai['foto']);
    //     // }
    //     $this->historiModel->delete($NIK);
    //     session()->setFlashdata('pesan', 'Data berhasil dihapus');
    //     return redirect()->to('/admin/histori');
    // }
    public function userList()
    {
        ...
        $dataPegawai = $this->adminModel->select('data_pegawai.id pegawaiid, foto, data_pegawai.nama, data_pegawai.NIK, histori.id_jabatan, jabatan')->join('histori', 'data_pegawai.NIK = histori.NIK')->join('jabatan', 'jabatan.id_jabatan = histori.id_jabatan')->where('histori.tgl_berakhir', null);
    ...
    public function histori()
    {
        ...
        $logHistori = $this->historiModel->select('histori.id,histori.NIK, histori.id_jabatan, jabatan, tgl_mulai, tgl_berakhir, histori.creator, histori.updator')->join('data_pegawai', 'data_pegawai.NIK = histori.NIK')->join('jabatan', 'jabatan.id_jabatan = histori.id_jabatan');
        $data['logHistori'] = $logHistori->paginate(5, 'histori');
        $data['pager'] = $this->historiModel->pager;
        return view('admin/histori', $data);
    }
