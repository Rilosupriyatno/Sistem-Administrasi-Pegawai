...
<div class="container">
    <div class="row">
        <div class="col-8">
            <h2 class="my-3">Tambah Jabatan Karyawan</h2>
            <form action="/Admin/mutate" method="POST" enctype="multipart/form-data">
                <?= csrf_field(); ?>
                <div class="row mb-3">
                    <label for="NIK" class="col-sm-2 col-form-label">NIK</label>
                    <div class="col-sm-10">
                        <select class="form-select form-control <?= ($validation->hasError('NIK')) ? 'is-invalid' : ''; ?>" aria-label="Default select example" id="NIK" name="NIK" autofocus value="<?= old('NIK'); ?>">
